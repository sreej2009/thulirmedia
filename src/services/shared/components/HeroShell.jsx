...
// Shared hero chrome (entrance timeline, exit-scrub parallax, marquee ticker,
// CTA layout) — every service page still gets its own bespoke `Scene` and
// copy, this just avoids re-deriving the same GSAP boilerplate six times.
export default function HeroShell({ id, hero, Scene }) {
  ...
  return (
    <section id={id} ref={rootRef} className="relative flex min-h-svh items-center overflow-hidden bg-void">
