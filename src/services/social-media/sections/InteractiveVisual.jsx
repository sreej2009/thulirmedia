...
import ContentPipelineScene from '../canvas/ContentPipelineScene'
...
export default function InteractiveVisual() {
  ...
  return (
    <section id="sm-visual" className="relative bg-void">
      ...
      <div ref={wrapRef} className="relative mt-12 h-[220vh] md:h-[240vh]">
        <div className="sticky top-0 h-svh w-full overflow-hidden">
          <ContentPipelineScene progressRef={progressRef} reducedMotion={reducedMotion} />
